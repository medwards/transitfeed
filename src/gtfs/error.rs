...
pub enum GtfsError {
    ...
    CsvHeader(String),
    LineError(ParseError, String, usize),
}
...
impl fmt::Display for GtfsError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ...
            GtfsError::LineError(_, ref file, ref line) => write!(f, "GtfsError: {} ({}:{}) - {:?}", self.description(), file, line, self.cause()),
        }
    }
}
...
impl error::Error for GtfsError {
    fn description(&self) -> &str {
        match *self {
            ...
            GtfsError::LineError(_, _, _) => "error reading line",
        }
    }
    ...
    fn cause(&self) -> Option<&error::Error> {
        match *self {
            ...
            GtfsError::LineError(ref err, _, _) => Some(err),
        }
    }
}
